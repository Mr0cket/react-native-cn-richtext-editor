...
import { StyleSheet, View, Image, Keyboard, Platform } from 'react-native';
...
export default class CNEditor extends Component {
  ...
  componentDidMount() {
    Platform.OS === 'ios'
      ? Keyboard.addListener('keyboardWillHide', () => this.blur())
  ...
  setHtml = htmlString => {
    const jsonString = JSON.stringify({ type: 'editor', command: 'setHtml', value: htmlString });
